...
import { u as useSEO, t as toast, s as supabase, S as ShepiLogo, B as Button, C as Card, b as CardHeader, d as CardTitle, e as CardDescription, P as PRICING, f as CardContent, A as Accordion, k as AccordionItem, l as AccordionTrigger, m as AccordionContent, i as trackEvent } from "../main.mjs";
...
import { u as useTosAcceptance, T as TermsAcceptanceModal } from "./TermsAcceptanceModal-iR4ZTu3u.js";
    ...
    /* @__PURE__ */ jsxs("main", { className: "container mx-auto px-4 py-16", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto items-stretch", children: [
        ...
        /* @__PURE__ */ jsxs(Card, { className: "border-2 border-accent relative flex flex-col", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsx("span", { className: "bg-accent text-accent-foreground px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap", children: "CPA-Signed" }) }),
          /* @__PURE__ */ jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsx(CardTitle, { children: "Done-For-You" }),
            /* @__PURE__ */ jsx(CardDescription, { children: "A licensed CPA on your deal — without the four-week wait." }),
            /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-col h-full space-y-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-muted-foreground", children: "Everything in Per Project, plus a Matched CPA who signs the work:" }),
            /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: [
              ...
              "CPA-led review by a licensed, accountable professional"
            ].map((feature) => /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 text-primary flex-shrink-0" }),
              /* @__PURE__ */ jsx("span", { className: "text-sm", children: feature })
            ] }, feature)) }),
            /* @__PURE__ */ jsxs("div", { className: "mt-auto space-y-4", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground text-center", children: "For when you want a real CPA on the report, fast." })
            ] })
          ] })
        ] }),
