...
import { n as cn, u as useSEO, S as ShepiLogo, B as Button } from "../main.mjs";
...
function ContentPageLayout({
  ...
  const mergedJsonLd = [breadcrumbJsonLd];
  if (jsonLd) {
    if (Array.isArray(jsonLd)) mergedJsonLd.push(...jsonLd);
