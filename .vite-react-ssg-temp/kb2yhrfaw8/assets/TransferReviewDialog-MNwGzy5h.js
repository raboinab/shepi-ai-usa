...
import { s as supabase, B as Button, C as Card, b as CardHeader, d as CardTitle, j as Badge, T as TooltipProvider, o as Tooltip, p as TooltipTrigger, q as TooltipContent, f as CardContent } from "../main.mjs";
...
function TransferReviewDialog({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      onOpenChange(false);
      const { toast } = await import("../main.mjs").then((n) => n.x);
