...
const CURRENT_TOS_VERSION = "2026-05-18";
...
function TermsContent() {
  return /* @__PURE__ */ jsxs("div", { className: "prose prose-sm max-w-none dark:prose-invert", children: [
    ...
    /* @__PURE__ */ jsx("p", { children: "shepi may use employees, contractors, affiliates, subprocessors, and other service providers to help deliver the Service. You authorize shepi to share Customer Data with those service providers as reasonably necessary to provide, maintain, support, and secure the Service, subject to confidentiality and data-protection obligations." }),
    /* @__PURE__ */ jsx("p", { children: "For Done-For-You projects, the licensed CPA who performs the professional services (the “Matched CPA”) is not shepi’s service provider. The Matched CPA is an independent licensed professional who performs the professional services in their professional capacity under §10 of these Terms and the Matched CPA’s professional license. The Matched CPA’s involvement creates a direct professional relationship between you and the Matched CPA, governed by the Matched CPA’s professional standards and applicable state rules." }),
