...
import { au as formatCell } from "./sanitizeWizardData-Dv9tWNGG.js";
import { n as cn } from "../main.mjs";
const ROW_HEIGHT = 24;
function SpreadsheetGrid({ data, onCellChange, onRowClick, className }) {
          ...
          virtualRows.map((virtualRow) => {
            ...
            return /* @__PURE__ */ jsx(
              "tr",
              {
                ...
                onClick: isClickable && !editingCell ? () => onRowClick(row.id) : void 0,
                children: row.type === "spacer" ? /* @__PURE__ */ jsx("td", { colSpan: frozenCols.length + scrollCols.length, className: "h-4" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                  frozenCols.map((col, i) => /* @__PURE__ */ jsx(
                    "td",
                    {
                      className: cn(
