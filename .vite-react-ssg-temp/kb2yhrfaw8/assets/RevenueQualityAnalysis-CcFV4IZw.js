...
function RevenueQualityAnalysis() {
  return /* @__PURE__ */ jsxs(
    ContentPageLayout,
    {
      ...
      seoTitle: "Revenue Quality Analysis: Customer & Recurring | Shepi",
      seoDescription: "Evaluate revenue quality in acquisitions. Customer concentration, recurring vs non-recurring revenue, AR aging, and revenue recognition red flags.",
