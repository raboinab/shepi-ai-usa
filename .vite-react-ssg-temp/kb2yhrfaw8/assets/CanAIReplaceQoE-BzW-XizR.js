  ...
  return /* @__PURE__ */ jsxs(
    ContentPageLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "not-prose mb-8 text-sm text-muted-foreground border border-border rounded-lg px-4 py-3 bg-muted/20", children: [
          "Want the shorter, opinionated take? Read",
          " ",
          /* @__PURE__ */ jsx(Link, { to: "/guides/ai-wont-do-your-qoe", className: "text-primary hover:underline font-medium", children: "AI Won't Do Your Quality of Earnings Analysis For You" }),
          " ",
