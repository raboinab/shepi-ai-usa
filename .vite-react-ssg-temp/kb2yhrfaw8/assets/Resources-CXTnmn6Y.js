...
import { FileSearch, BookOpen, Users, GitCompare, Zap, ArrowRight } from "lucide-react";
import { C as ContentPageLayout } from "./ContentPageLayout-DCN4h0e5.js";
import { j as Badge, C as Card, b as CardHeader, d as CardTitle, e as CardDescription } from "../main.mjs";
...
function Resources() {
  return /* @__PURE__ */ jsxs(
    ContentPageLayout,
    {
      ...
      heroAccent: true,
      children: [
        /* @__PURE__ */ jsx("p", { className: "text-lg mb-10", children: "Everything you need to understand Quality of Earnings analysis — from foundational guides to practical comparisons and deep dives into our platform's capabilities." }),
        /* @__PURE__ */ jsx("div", { className: "space-y-10 not-prose", children: sections.map((section, sectionIdx) => /* @__PURE__ */ jsxs("div", { children: [
          sectionIdx > 0 && /* @__PURE__ */ jsx(Separator, { className: "mb-10" }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsx(section.icon, { className: "w-5 h-5 text-primary" }) }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("h2", { className: "text-xl font-serif font-bold text-foreground", children: section.title }),
              /* @__PURE__ */ jsxs(Badge, { variant: "secondary", className: "text-xs", children: [
                section.links.length,
                " ",
                section.links.length === 1 ? "article" : "articles"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-5", children: section.description }),
          /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4", children: section.links.map((link) => /* @__PURE__ */ jsx(Link, { to: link.to, children: /* @__PURE__ */ jsx(Card, { className: "h-full hover:border-primary/40 transition-colors group cursor-pointer", children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-4", children: [
            /* @__PURE__ */ jsxs(CardTitle, { className: "text-base font-medium group-hover:text-primary transition-colors flex items-center gap-2", children: [
              link.label,
              /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity shrink-0" })
            ] }),
            /* @__PURE__ */ jsx(CardDescription, { className: "text-xs leading-relaxed mt-1.5", children: link.description })
          ] }) }) }, link.to)) })
        ] }, section.title)) }),
        /* @__PURE__ */ jsxs("div", { className: "mt-16 text-center not-prose flex flex-col items-center", children: [
