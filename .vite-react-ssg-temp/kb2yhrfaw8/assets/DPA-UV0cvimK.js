    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      ...
      /* @__PURE__ */ jsxs("section", { children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground mt-4", children: [
          /* @__PURE__ */ jsx("strong", { children: "AI sub-processor retention." }),
          " All AI model requests (document parsing, financial analysis, narrative generation, and vector embeddings) are routed through Vercel AI Gateway under a Zero Data Retention (ZDR) agreement. Upstream model providers (including Anthropic and OpenAI) act as sub-processors under no-retention terms: prompts and completions containing Controller data are ",
          /* @__PURE__ */ jsx("strong", { children: "not stored" }),
          " by the model provider after the request completes, and are ",
          /* @__PURE__ */ jsx("strong", { children: "not used to train" }),
          " ",
          "any model. ZDR enforcement is verified at runtime by the Processor before any AI request is issued."
        ] })
      ] }),
      /* @__PURE__ */ jsxs("section", { children: [
