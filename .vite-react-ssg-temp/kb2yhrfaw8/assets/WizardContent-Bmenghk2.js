...
import { S as Sheet, a as SheetTrigger, b as SheetContent } from "./sheet-DEVVWd_r.js";
import { n as cn, j as Badge, B as Button, A as Accordion, k as AccordionItem, l as AccordionTrigger, m as AccordionContent, C as Card, f as CardContent, T as TooltipProvider, o as Tooltip, p as TooltipTrigger, q as TooltipContent } from "../main.mjs";
...
import { p as projectToDealData } from "./sanitizeWizardData-Dv9tWNGG.js";
import { b as buildWizardReports } from "./InsightsView-C9eH5gNO.js";
...
const ProjectSetupSection = lazy(() => import("./ProjectSetupSection-Dw1KrgpM.js").then((m) => ({ default: m.ProjectSetupSection })));
const ChartOfAccountsSection = lazy(() => import("./ChartOfAccountsSection-VI1FpYaN.js").then((m) => ({ default: m.ChartOfAccountsSection })));
const TrialBalanceSection = lazy(() => import("./TrialBalanceSection-16nWCvGc.js").then((m) => ({ default: m.TrialBalanceSection })));
const DocumentUploadSection = lazy(() => import("./DocumentUploadSection-B-MQyT1-.js").then((m) => ({ default: m.DocumentUploadSection })));
const DDAdjustmentsSection = lazy(() => import("./DDAdjustmentsSection-CHGiASh0.js").then((m) => ({ default: m.DDAdjustmentsSection })));
const ReclassificationsSection = lazy(() => import("./ReclassificationsSection-CpQELOLd.js").then((m) => ({ default: m.ReclassificationsSection })));
const JournalEntriesSection = lazy(() => import("./JournalEntriesSection-NFe_ywzn.js").then((m) => ({ default: m.JournalEntriesSection })));
const ARAgingSection = lazy(() => import("./ARAgingSection-ZyFV2aon.js").then((m) => ({ default: m.ARAgingSection })));
const APAgingSection = lazy(() => import("./APAgingSection-CUiuSWYF.js").then((m) => ({ default: m.APAgingSection })));
const FixedAssetsSection = lazy(() => import("./FixedAssetsSection-CN9etF3C.js").then((m) => ({ default: m.FixedAssetsSection })));
const InventorySection = lazy(() => import("./InventorySection-YEUJ38g5.js").then((m) => ({ default: m.InventorySection })));
const TopCustomersSection = lazy(() => import("./TopCustomersSection-Ek_ctXuR.js").then((m) => ({ default: m.TopCustomersSection })));
const TopVendorsSection = lazy(() => import("./TopVendorsSection-C0fBh1z3.js").then((m) => ({ default: m.TopVendorsSection })));
const IncomeStatementSection = lazy(() => import("./IncomeStatementSection-DrEYkedL.js").then((m) => ({ default: m.IncomeStatementSection })));
const BalanceSheetSection = lazy(() => import("./BalanceSheetSection-CrcPjcno.js").then((m) => ({ default: m.BalanceSheetSection })));
const QoESummarySection = lazy(() => import("./QoESummarySection-DCHcG8Ee.js").then((m) => ({ default: m.QoESummarySection })));
const PayrollSection = lazy(() => import("./PayrollSection-GahN9lr1.js").then((m) => ({ default: m.PayrollSection })));
const NWCFCFSection = lazy(() => import("./NWCFCFSection-BGmKGTYl.js").then((m) => ({ default: m.NWCFCFSection })));
const ProofOfCashSection = lazy(() => import("./ProofOfCashSection-CkTdWM5Z.js").then((m) => ({ default: m.ProofOfCashSection })));
const SupplementarySection = lazy(() => import("./SupplementarySection-BFcQp4c4.js").then((m) => ({ default: m.SupplementarySection })));
const MaterialContractsSection = lazy(() => import("./MaterialContractsSection-DxA7TGVm.js").then((m) => ({ default: m.MaterialContractsSection })));
const QoEExecutiveSummarySection = lazy(() => import("./QoEExecutiveSummarySection-DwQ5hZrr.js").then((m) => ({ default: m.QoEExecutiveSummarySection })));
const FinancialReportsSection = lazy(() => import("./FinancialReportsSection-BCp0lb6M.js").then((m) => ({ default: m.FinancialReportsSection })));
const AnalysisReportsSection = lazy(() => import("./AnalysisReportsSection-CK316OjF.js").then((m) => ({ default: m.AnalysisReportsSection })));
const ExportCenterSection = lazy(() => import("./ExportCenterSection-BdVZDyHS.js").then((m) => ({ default: m.ExportCenterSection })));
const GenericReportSection = lazy(() => import("./GenericReportSection-DZKVjYv2.js").then((m) => ({ default: m.GenericReportSection })));
