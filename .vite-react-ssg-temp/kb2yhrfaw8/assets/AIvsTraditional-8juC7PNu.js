...
function AIvsTraditional() {
  return /* @__PURE__ */ jsxs(
    ContentPageLayout,
    {
      ...
      heroAccent: true,
      children: [
        /* @__PURE__ */ jsx(HeroCallout, { children: "There are now three real ways to get a QoE. They serve different deal sizes, budgets, and risk profiles." }),
        /* @__PURE__ */ jsx("p", { className: "text-lg", children: "Quality of Earnings analysis used to be a binary choice: do it yourself in Excel, or hire a CPA firm. shepi added a software option, and now a Done-For-You tier where a matched, licensed CPA signs the deliverable. Here's how the three stack up." }),
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          " work spans a spectrum — from a buyer kicking the tires pre-LOI to a lender-mandated, firm-attested report on a $50M deal. The right tool depends on where your deal sits on that spectrum."
        ] }),
        /* @__PURE__ */ jsx("h2", { id: "three-options", children: "The Three Options" }),
        ...
        /* @__PURE__ */ jsx("h2", { id: "cost-comparison", children: "Side-by-Side" }),
        /* @__PURE__ */ jsx(
          ComparisonTable,
          {
