...
import { B as Button, n as cn } from "../main.mjs";
import { W as WORKBOOK_TABS } from "./workbook-tabs-EPVJV9jR.js";
...
const TrialBalanceTab = lazy(() => import("./TrialBalanceTab-Bpbnz3oe.js").then((m) => ({ default: m.TrialBalanceTab })));
const QoEAnalysisTab = lazy(() => import("./QoEAnalysisTab-uv3R1Bg2.js").then((m) => ({ default: m.QoEAnalysisTab })));
const DDAdjustmentsTab = lazy(() => import("./DDAdjustmentsTab-BJD9AXfk.js").then((m) => ({ default: m.DDAdjustmentsTab })));
const IncomeStatementTab = lazy(() => import("./IncomeStatementTab-DSczAxJl.js").then((m) => ({ default: m.IncomeStatementTab })));
const ISDetailedTab = lazy(() => import("./ISDetailedTab-CiJbDXMM.js").then((m) => ({ default: m.ISDetailedTab })));
const BalanceSheetTab = lazy(() => import("./BalanceSheetTab-l17TafTP.js").then((m) => ({ default: m.BalanceSheetTab })));
const BSDetailedTab = lazy(() => import("./BSDetailedTab-389peWQa.js").then((m) => ({ default: m.BSDetailedTab })));
const SalesTab = lazy(() => import("./SalesTab-CzCkGPXW.js").then((m) => ({ default: m.SalesTab })));
const COGSTab = lazy(() => import("./COGSTab-B3G50Nfl.js").then((m) => ({ default: m.COGSTab })));
const OpExTab = lazy(() => import("./OpExTab-DmuQYCzC.js").then((m) => ({ default: m.OpExTab })));
const OtherExpenseTab = lazy(() => import("./OtherExpenseTab-CFr_0KbC.js").then((m) => ({ default: m.OtherExpenseTab })));
const PayrollTab = lazy(() => import("./PayrollTab-eMN-baxa.js").then((m) => ({ default: m.PayrollTab })));
const WorkingCapitalTab = lazy(() => import("./WorkingCapitalTab-CnTFKIo9.js").then((m) => ({ default: m.WorkingCapitalTab })));
const NWCAnalysisTab = lazy(() => import("./NWCAnalysisTab-Ce_lAANo.js").then((m) => ({ default: m.NWCAnalysisTab })));
const CashTab = lazy(() => import("./CashTab-BBzRj4RL.js").then((m) => ({ default: m.CashTab })));
const ARAgingTab = lazy(() => import("./ARAgingTab-CfIW5OFR.js").then((m) => ({ default: m.ARAgingTab })));
const OtherCurrentAssetsTab = lazy(() => import("./OtherCurrentAssetsTab-Cniva3AZ.js").then((m) => ({ default: m.OtherCurrentAssetsTab })));
const FixedAssetsTab = lazy(() => import("./FixedAssetsTab-xptjKB8a.js").then((m) => ({ default: m.FixedAssetsTab })));
const APAgingTab = lazy(() => import("./APAgingTab-CgwQgZ7b.js").then((m) => ({ default: m.APAgingTab })));
const OtherCurrentLiabilitiesTab = lazy(() => import("./OtherCurrentLiabilitiesTab-BK3uU0oq.js").then((m) => ({ default: m.OtherCurrentLiabilitiesTab })));
const SupplementaryTab = lazy(() => import("./SupplementaryTab-BWo_rXU6.js").then((m) => ({ default: m.SupplementaryTab })));
const TopCustomersTab = lazy(() => import("./TopCustomersTab-DyFGWqb9.js").then((m) => ({ default: m.TopCustomersTab })));
const TopVendorsTab = lazy(() => import("./TopVendorsTab-BNdc_Chn.js").then((m) => ({ default: m.TopVendorsTab })));
const ProofOfCashTab = lazy(() => import("./ProofOfCashTab-CFmqkYhn.js").then((m) => ({ default: m.ProofOfCashTab })));
const FreeCashFlowTab = lazy(() => import("./FreeCashFlowTab-D5_Ckcz1.js").then((m) => ({ default: m.FreeCashFlowTab })));
const ISBSReconciliationTab = lazy(() => import("./ISBSReconciliationTab-D6kSC5Nh.js").then((m) => ({ default: m.ISBSReconciliationTab })));
const WIPScheduleTab = lazy(() => import("./WIPScheduleTab-DKyM467d.js").then((m) => ({ default: m.WIPScheduleTab })));
