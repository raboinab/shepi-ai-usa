...
function AIDueDiligence() {
  return /* @__PURE__ */ jsxs(
    ContentPageLayout,
    {
      ...
      heroAccent: true,
      children: [
        /* @__PURE__ */ jsx(HeroCallout, { children: "AI doesn't replace the analyst — it gives every analyst the throughput of a team. Screen more deals, catch more issues, close faster." }),
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          "AI-powered financial due diligence applies machine learning, natural language processing, and structured analysis to the ",
          /* @__PURE__ */ jsx(Link, { to: "/guides/quality-of-earnings", children: "Quality of Earnings process" }),
          ". Instead of analysts manually reviewing thousands of transactions, AI handles the data-intensive work while humans focus on judgment, context, and deal strategy."
        ] }),
        /* @__PURE__ */ jsx("h2", { id: "what-ai-automates", children: "What AI Automates in Due Diligence" }),
        ...
        /* @__PURE__ */ jsx("h2", { id: "workflow", children: "AI-Assisted Due Diligence Workflow" }),
        ...
        /* @__PURE__ */ jsx("h2", { id: "gl-analysis", children: "GL-Level AI Analysis" }),
        /* @__PURE__ */ jsxs("p", { children: [
          "The ",
          /* @__PURE__ */ jsx(Link, { to: "/guides/general-ledger-review", children: "general ledger" }),
          " is where AI delivers the most dramatic improvement over manual processes:"
        ] }),
        /* @__PURE__ */ jsx(BenefitGrid, { benefits: [
        ...
        /* @__PURE__ */ jsx("h2", { id: "vs-traditional", children: "AI vs Traditional Due Diligence" }),
        /* @__PURE__ */ jsx(
          ComparisonTable,
          {
            ...
            rows: [
              ...
              ["Cost", "$20K+", `Starting at ${PRICING.perProject.display}`],
        ...
        /* @__PURE__ */ jsx("h2", { id: "when-to-use", children: "When to Use AI Due Diligence" }),
        /* @__PURE__ */ jsx(BenefitGrid, { benefits: [
        ...
        /* @__PURE__ */ jsx("p", { children: "We believe in transparency about what AI can and cannot do:" }),
        /* @__PURE__ */ jsx(BenefitGrid, { benefits: [
