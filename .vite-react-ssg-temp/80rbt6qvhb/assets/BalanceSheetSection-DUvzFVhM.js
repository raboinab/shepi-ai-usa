  ...
  if (!hasPeriods) {
    return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-serif font-bold", children: "Balance Sheet" }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Assets, liabilities, and equity positions by period" })
      ] }),
  ...
  if (!hasRawData) {
    return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "p-8 text-center text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm mt-1", children: "Sync data from your spreadsheet to view the Balance Sheet report." })
      ] }) })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
