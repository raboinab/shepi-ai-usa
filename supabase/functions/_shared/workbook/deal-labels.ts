/**
 * Dynamic label resolution for account matching (server-side copy).
 * Mirrors src/lib/deal-labels.ts — keep in sync.
 */
...
const TAX_ALIASES = new Set([
  "tax", "taxes", "income tax", "income taxes",
  "tax expense", "provision for income taxes",
]);

const DEPRECIATION_ALIASES = new Set([
  "depreciation", "depreciation expense",
  "depreciation and amortization", "d&a",
]);

const AMORTIZATION_ALIASES = new Set([
