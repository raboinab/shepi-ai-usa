DO $$
BEGIN
  DELETE FROM public.verification_transaction_snapshots WHERE verification_attempt_id IN (SELECT id FROM public.verification_attempts WHERE project_id = '7ed459ed-a728-4bec-9e9d-b35eb036d46a');
  DELETE FROM public.verification_attempts WHERE project_id = '7ed459ed-a728-4bec-9e9d-b35eb036d46a';
