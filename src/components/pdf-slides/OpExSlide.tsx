...
export function OpExSlide({ metadata, pageNumber, totalPages, data }: SlideProps) {
  ...
  const BOLD_KEYS = ["total", "operating", "net income", "ebitda"];
  const rows = hasData
    ...
    : [
        { cells: { item: "Payroll & Benefits", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Rent & Occupancy", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Insurance", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Total Operating Expenses", fy1: "—", fy2: "—", ltm: "—" }, bold: true, highlight: true },
      ];
