...
export function ARAgingSlide({ metadata, pageNumber, totalPages, data }: SlideProps) {
  ...
  const BOLD_KEYS = ["total", "net receivables", "allowance"];
  const rows = hasData
    ...
    : [
        { cells: { item: "Trade Receivables", current: "—", d30: "—", d60: "—", d90: "—", over90: "—", total: "—" }, bold: false },
        { cells: { item: "Total AR", current: "—", d30: "—", d60: "—", d90: "—", over90: "—", total: "—" }, bold: true, highlight: true },
      ];
