...
export function NWCAnalysisSlide({ metadata, pageNumber, totalPages, data }: SlideProps) {
  ...
  const BOLD_KEYS = ["total", "net working capital", "nwc", "change", "days"];
  const rows = hasData
    ...
    : [
        { cells: { item: "NWC — Beginning", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "NWC — Ending", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Change in NWC", fy1: "—", fy2: "—", ltm: "—" }, bold: true, highlight: true },
        { cells: {}, separator: true },
        { cells: { item: "Days Sales Outstanding", fy1: "—", fy2: "—", ltm: "—" }, bold: true },
        { cells: { item: "Days Payable Outstanding", fy1: "—", fy2: "—", ltm: "—" }, bold: true },
        { cells: { item: "Cash Conversion Cycle", fy1: "—", fy2: "—", ltm: "—" }, bold: true, highlight: true },
      ];
