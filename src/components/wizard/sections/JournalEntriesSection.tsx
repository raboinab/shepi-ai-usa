...
import { BookOpen, Search, ChevronRight, ChevronDown, Play, RefreshCw } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <RunJEAnalysisButton projectId={projectId} />
        </div>
      </div>
...
function RunJEAnalysisButton({ projectId }: { projectId: string }) {
  ...
  return (
    <Button size="sm" variant={data ? "outline" : "default"} onClick={runAnalysis} disabled={running}>
