...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { to: "/guides/cash-proof-analysis", label: "Cash & Bank Tie-Out Guide", description: "Proof of cash methodology, GL-to-bank reconciliation, commingled expense detection, and unrecorded liability identification." },
        ...
        { to: "/guides/qoe-vs-audit", label: "Quality of Earnings vs Financial Audit", description: "How a QoE analysis differs from a traditional financial audit — prospective valuation focus vs historical GAAP compliance." },
  ...
  },
  {
    ...
    links: [
      { to: "/features/accounting-integration", label: "Accounting Integration for QoE", description: "Direct data pull, automatic account mapping, multi-period support, and secure OAuth." },
