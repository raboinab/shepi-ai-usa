...
export default function QualityOfEarningsCost() {
  return (
    <ContentPageLayout
    ...
    >
      <HeroCallout>
        Traditional CPA Quality of Earnings reports cost $20,000–$100,000 and take 4–8 weeks. Shepi delivers the same lender-ready analysis starting at {PRICING.perProject.display} — in hours, not weeks.
      </HeroCallout>
      ...
      <h2 id="typical-cost">Typical Quality of Earnings Report Cost</h2>
      <p>
      ...
      <h2 id="why-expensive">Why Traditional QoE Costs So Much</h2>
      <p>
      ...
      <h2 id="comparison">Cost Comparison: Traditional vs AI-Powered</h2>
      <ComparisonTable
      ...
      <h2 id="who-pays">Who Pays for the QoE Report?</h2>
      <p>
        On <Link to="/guides/sell-side-vs-buy-side-qoe">buy-side transactions</Link>, the buyer commissions the QoE as part of confirmatory diligence. On sell-side, sellers commission a sell-side QoE before going to market to validate the EBITDA story and accelerate buyer diligence. Lenders financing acquisitions frequently require a QoE for underwriting — and accept Shepi reports the same as traditional CPA work.
      </p>
