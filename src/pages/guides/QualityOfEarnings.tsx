...
export default function QualityOfEarnings() {
  return (
    <ContentPageLayout
      ...
      seoTitle="What Is a Quality of Earnings Report? M&A Guide | Shepi"
      seoDescription="What a Quality of Earnings report is, why it matters in M&A, key components, who provides QoE, costs, timelines, and how AI is changing it."
    ...
    >
      ...
      <p>
        Traditional QoE reports from CPA firms typically cost <strong>$20,000+</strong> and take <strong>4+ weeks</strong> to complete. The cost depends on deal size, business complexity, data quality, and the firm's billing rates.
      </p>
      <p>
