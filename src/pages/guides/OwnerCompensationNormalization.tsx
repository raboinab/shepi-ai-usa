...
export default function OwnerCompensationNormalization() {
  return (
    <ContentPageLayout
      ...
      seoTitle="Owner Compensation Normalization for QoE | Shepi"
      seoDescription="Normalize owner compensation for QoE. Salary, benefits, personal expenses, market-rate replacement, and supporting documentation."
