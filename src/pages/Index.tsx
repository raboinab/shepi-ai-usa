...
const Index = () => {
  const __seoTags = useSEO({
    title: "AI Quality of Earnings Software | QoE Analysis | Shepi",
    description: "AI-powered Quality of Earnings analysis for M&A due diligence. Get EBITDA adjustments and lender-ready QoE reports in hours. Built for PE and deal teams.",
      ...
      <section className="bg-primary min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-6 md:px-12">
          <div className="max-w-4xl text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold text-primary-foreground mb-6 leading-[1.2] text-center pt-2 pb-1 overflow-visible">
              Intelligent
              <br />
