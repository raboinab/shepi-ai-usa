...
const Index = () => {
  const __seoTags = useSEO({
    title: "AI Quality of Earnings Software | QoE Analysis Platform |",
    description: "AI quality of earnings analysis for M&A due diligence. Upload financials, get EBITDA adjustments and lender-ready QoE reports in hours.",
