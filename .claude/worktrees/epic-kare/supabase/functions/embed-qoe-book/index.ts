...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`[embed-qoe-book] Admin access granted for user ${userData.user.id}`);
      ...
      for (const result of results) {
        ...
        const { error } = await supabase
          ...
          .insert({
            ...
            metadata: {
              source: "Quality of Earnings by Thornton L. O'Glove",
    ...
    console.error("Error in embed-qoe-book function:", error);
    return new Response(
