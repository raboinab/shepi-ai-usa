    ...
    const softwareSchema = {
      ...
      "offers": [
        ...
        },
        {
          ...
          "price": "5000",
          "priceCurrency": "USD",
          "description": "Monthly subscription for unlimited projects"
        }
      ]
    };
        ...
        <div className="flex-1 flex items-center justify-center px-6 md:px-12">
          <div className="max-w-4xl text-center">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/70 mb-6 max-w-3xl mx-auto">
              Shepi guides you through professional-grade Quality of Earnings analysis, helping you identify adjustments, risks, and normalized earnings with confidence.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                size="lg"
                variant="ghost"
                className="text-primary-foreground/60 hover:text-primary-foreground/80 hover:bg-primary-foreground/5 gap-2 text-lg px-8 py-6"
                onClick={() => toast({ title: "Coming Soon!", description: "Video walkthrough coming soon! Try the live demo in the meantime." })}
              >
                Watch Demo
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 border border-secondary/20 rounded-lg">
              ...
              <div className="text-4xl md:text-5xl font-bold text-secondary mb-2">$20K–$100K+</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6 text-center">
              Traditional QoE reports cost $20–100K and take 4–8 weeks — putting proper due diligence out of reach for searchers, slowing down deals, and forcing buyers to choose between speed and credibility.
            </p>
              ...
              <AccordionItem value="how-1" className="border border-border rounded-lg px-4 bg-card">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  ...
                  <ul className="list-disc list-inside mb-3 ml-2 space-y-1">
                    ...
                    <li>Income Statement & Balance Sheet (for verification)</li>
                  </ul>
                  <p className="mb-2"><strong className="text-foreground">Optional</strong> — For enhanced insights:</p>
                  <ul className="list-disc list-inside mb-3 ml-2 space-y-1">
                    <li>Credit Card Statements</li>
                    <li>Journal Entries</li>
                    <li>Customer & Vendor concentration lists</li>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          {!showCalendar ? (
            ...
            <div className="mt-4 rounded-lg overflow-hidden border border-border">
              <iframe
                src="https://calendar.google.com/calendar/appointments/schedules/AcZssZ2qE2ZwYpCRi1MB-Ms9GnB1K7K3PpPCYankr9qdPiyVQYN8TqT9ZnkFuBz4mGlT4Lj0OukzYIrG?gv=true"
                style={{ border: 0 }}
                width="100%"
                height="600"
