...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: `Traditional CPA QoE engagements cost $20,000-$100,000+. Shepi's AI-powered QoE platform starts at ${PRICING.perProject.display} per project, making professional-grade analysis accessible for deals of all sizes.`,
      },
    },
  ],
};
    ...
    >
      ...
      <ComparisonTable
        ...
        rows={[
          ...
          ["Cost", "$20K–$100K+ (CPA firm)", `Starting at ${PRICING.perProject.display}`],
      ...
      <AccordionFAQ items={[
        ...
        { question: "How much does QoE software cost?", answer: `Traditional CPA QoE costs $20K–$100K+. Shepi starts at ${PRICING.perProject.display} per project.` },
      ]} />
