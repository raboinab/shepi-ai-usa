...
const Pricing = () => {
  ...
  const [pendingPlanType, setPendingPlanType] = useState<'monthly' | 'per_project' | null>(null);
  ...
  const proceedToCheckout = async (planType: 'monthly' | 'per_project') => {
  ...
  const handleCheckout = (planType: 'monthly' | 'per_project') => {
    if (!user) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          ...
          {/* Done-For-You */}
          <Card className="border border-muted-foreground/30 relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <span className="bg-muted text-muted-foreground px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap">
                Coming Soon
              </span>
            </div>
            <CardHeader>
              <CardTitle>Done-For-You</CardTitle>
              <CardDescription>For buyers who want results, not workflow</CardDescription>
              <div className="mt-4">
            ...
            <CardContent className="flex flex-col h-full space-y-4">
              <ul className="space-y-3">
                {[
                  ...
                  "Analyst-led execution",
                  "End-to-end project completion",
                  "Adjustment summary memo",
              ...
              <Link to="/auth?mode=signup" className="block">
                <Button variant="outline" className="w-full">Reserve Your Spot</Button>
              </Link>
              <p className="text-xs text-muted-foreground text-center mt-auto">
                Ideal for buyers under LOI who need speed and credibility
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border">
            <CardHeader>
              ...
              <CardDescription>For firms & advisory practices</CardDescription>
              <div className="mt-4">
            ...
            <CardContent className="flex flex-col h-full space-y-4">
              ...
              <p className="text-xs text-muted-foreground text-center mt-auto">
                For teams and high-volume practices
              </p>
            </CardContent>
          </Card>
        </div>
