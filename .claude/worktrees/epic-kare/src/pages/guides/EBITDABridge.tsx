...
export default function EBITDABridge() {
  return (
    ...
    >
      ...
      <h2 id="what-is-ebitda-bridge">What Is an EBITDA Bridge?</h2>
      <p>
        An EBITDA bridge (also called an <strong>EBITDA reconciliation</strong> or <strong>adjustment schedule</strong>) is a structured walk from a company's reported net income to its adjusted EBITDA. Each line item represents a specific adjustment — add-back or deduction — with categorization and supporting documentation.
      </p>
      <p>
        The bridge is the centerpiece of any <Link to="/guides/quality-of-earnings">Quality of Earnings report</Link> and the primary basis for purchase price negotiations.
      </p>

      <h2 id="structure">Bridge Structure</h2>
      <StepList steps={[
      ...
      <h2 id="adjustment-categories">Adjustment Categories</h2>
      ...
      <p>
        For a deep dive into each category, see our <Link to="/guides/ebitda-adjustments">EBITDA adjustments guide</Link>.
      </p>

      <h2 id="reconciliation">Net Income to EBITDA Reconciliation</h2>
      <p>
        The reconciliation must be precise and traceable. Every number should tie back to a specific line in the financial statements or a specific transaction in the <Link to="/guides/general-ledger-review">general ledger</Link>.
      </p>
      <BenefitGrid benefits={[
      ...
      <h2 id="run-rate">Run-Rate EBITDA</h2>
      <p>
        Run-rate EBITDA takes adjusted EBITDA one step further by incorporating <strong>known future changes</strong> that will impact earnings going forward:
      </p>
      <BenefitGrid benefits={[
      ...
      <h2 id="documentation">Supporting Documentation</h2>
      <BenefitGrid benefits={[
