...
export default function DueDiligenceChecklist() {
  return (
    ...
    >
      ...
      <AccordionFAQ items={[
        { question: "How long should due diligence take?", answer: "Traditional due diligence takes 4–8 weeks for financial DD alone. AI-assisted tools can significantly compress the analysis timeline, though document collection from the seller remains a common bottleneck." },
