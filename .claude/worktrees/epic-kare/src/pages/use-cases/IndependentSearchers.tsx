...
export default function IndependentSearchers() {
  return (
    ...
    >
      ...
      <p>
        Traditional QoE from a CPA firm costs $20,000–$60,000 for a small business acquisition. For a searcher evaluating a $2M deal, that's 1–3% of enterprise value — a significant cost when the deal might not close. This creates two bad outcomes:
      </p>
      <BenefitGrid benefits={[
