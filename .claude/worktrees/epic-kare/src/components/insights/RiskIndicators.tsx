...
import { AlertTriangle, Users, Building, Clock, TrendingDown } from "lucide-react";
...
export const RiskIndicators = ({ wizardData }: RiskIndicatorsProps) => {
  ...
  const hasData = top1CustomerPct > 0 || top1VendorPct > 0 || arOver90Pct > 0 || totalDebt > 0 || totalContracts > 0;
