...
export function VendorConcentrationSlide({ metadata, pageNumber, totalPages, data }: SlideProps) {
  ...
  const rows = hasData
    ...
    : [
        { cells: { rank: "1", vendor: "Vendor A", spend: "—", pct: "—" }, bold: false },
        { cells: { rank: "2", vendor: "Vendor B", spend: "—", pct: "—" }, bold: false },
        { cells: { rank: "3", vendor: "Vendor C", spend: "—", pct: "—" }, bold: false },
        { cells: {}, separator: true },
        { cells: { rank: "", vendor: "Top 5 Total", spend: "—", pct: "—" }, bold: true, highlight: true },
        { cells: { rank: "", vendor: "All Others", spend: "—", pct: "—" }, bold: false },
        { cells: { rank: "", vendor: "Total Spend", spend: "—", pct: "100%" }, bold: true, highlight: true },
      ];
