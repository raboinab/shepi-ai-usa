...
export function ProofOfCashSlide({ metadata, pageNumber, totalPages, data }: SlideProps) {
  ...
  const BOLD_KEYS = ["opening", "closing", "total", "variance", "net cash", "balance"];
  const rows = hasData
    ...
    : [
        { cells: { item: "Opening Balance (Bank)", fy1: "—", fy2: "—", ltm: "—" }, bold: true },
        { cells: { item: "Total Credits", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Total Debits", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Closing Balance (Bank)", fy1: "—", fy2: "—", ltm: "—" }, bold: true },
        { cells: {}, separator: true },
        { cells: { item: "Closing Balance (GL)", fy1: "—", fy2: "—", ltm: "—" }, bold: true },
        { cells: { item: "Variance (GL vs Bank)", fy1: "—", fy2: "—", ltm: "—" }, bold: true, highlight: true },
      ];

  return (
    <SlideLayout metadata={metadata} pageNumber={pageNumber} totalPages={totalPages} sectionTitle="Proof of Cash">
