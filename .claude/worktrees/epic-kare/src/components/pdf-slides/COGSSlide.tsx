...
export function COGSSlide({ metadata, pageNumber, totalPages, data }: SlideProps) {
  ...
  const BOLD_KEYS = ["total", "cogs", "cost of goods", "gross profit"];
  const rows = hasData
    ...
    : [
        { cells: { item: "Materials", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Direct Labor", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Subcontractors", fy1: "—", fy2: "—", ltm: "—" }, bold: false },
        { cells: { item: "Total COGS", fy1: "—", fy2: "—", ltm: "—" }, bold: true, highlight: true },
      ];
