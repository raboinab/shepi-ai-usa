 ...
 * Single table with sticky frozen columns for perfect row alignment.
 */
...
export function SpreadsheetGrid({ data, onCellChange, className }: SpreadsheetGridProps) {
  ...
  return (
    <div className={cn("financial-grid overflow-auto border border-[hsl(var(--excel-grid,220_13%_91%))] rounded-sm", className)}>
        ...
        <thead>
          <tr className="bg-[hsl(var(--excel-header-bg,220_14%_96%))]">
            {frozenCols.map((col, i) => (
              <th
                key={col.key}
                className="px-2 py-1 text-left font-semibold border-b border-[hsl(var(--excel-grid,220_13%_91%))] whitespace-nowrap sticky bg-[hsl(var(--excel-header-bg,220_14%_96%))] z-20"
            ...
            {scrollCols.map(col => (
              <th
                key={col.key}
                className="px-2 py-1 text-right font-semibold border-b border-[hsl(var(--excel-grid,220_13%_91%))] whitespace-nowrap"
