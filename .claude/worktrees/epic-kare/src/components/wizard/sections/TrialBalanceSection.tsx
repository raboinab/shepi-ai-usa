...
export const TrialBalanceSection = ({
  ...
  // Auto-import from processed_data on mount if accounts are empty
  useEffect(() => {
    if (accountsRef.current.length > 0) {
      console.log('[TrialBalance] Auto-import skipped, already have', accountsRef.current.length, 'accounts');
      return;
    }
