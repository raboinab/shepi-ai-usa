...
export function MultiPeriodTable({
  ...
  // Calculate balance check for each period
      ...
      <ScrollArea className="w-full h-full" type="always">
        <div className="min-w-max" ref={tableRef}>
          ...
          <div className="flex bg-muted border-b border-border sticky top-0 z-20">
            {/* Frozen columns */}
            <div className="flex sticky left-0 z-30 bg-muted">
              <div className="w-16 px-2 py-2.5 text-xs font-semibold text-muted-foreground border-r border-border">FS</div>
              <div className="w-20 px-2 py-2.5 text-xs font-semibold text-muted-foreground border-r border-border">Acct #</div>
              <div className="w-48 px-2 py-2.5 text-xs font-semibold text-muted-foreground border-r border-border">Account Name</div>
              <div className="w-44 px-2 py-2.5 text-xs font-semibold text-muted-foreground border-r border-border">FS Line Item</div>
              <div className="w-36 px-2 py-2.5 text-xs font-semibold text-muted-foreground border-r border-border">Sub-acct 1</div>
              <div className="w-36 px-2 py-2.5 text-xs font-semibold text-muted-foreground border-r border-border">Sub-acct 2</div>
            </div>
          ...
          {accounts.map((account, index) => {
            ...
            >
              {/* Frozen columns */}
              <div className={`flex sticky left-0 z-10 ${index % 2 === 0 ? 'bg-background' : 'bg-muted/20'}`}>
                <div className="w-16 px-1 py-1.5 border-r border-border flex items-center gap-1">
                  {showIndicator && (
                    <Tooltip>
                ...
                <div className="w-20 px-1 py-1.5 border-r border-border">
                  <Input
                ...
                <div className="w-48 px-1 py-1.5 border-r border-border">
                  <Input
                ...
                <div className="w-44 px-1 py-1.5 border-r border-border">
                  <Input
                ...
                <div className="w-36 px-1 py-1.5 border-r border-border">
                  <Input
              ...
              {displayPeriods.map(period => {
                ...
                return (
                  <div 
                    key={period.id}
                    className={cn("w-28 px-1 py-1.5 border-r border-border", period.isStub && "bg-accent/20")}
              ...
              {/* Actions */}
              <div className={`w-12 px-1 py-1.5 flex items-center justify-center sticky right-0 z-10 ${index % 2 === 0 ? 'bg-background' : 'bg-muted/20'}`}>
                <Button
                  variant="ghost"
                  size="sm"
          ...
          <div className="flex border-b border-border bg-muted/40">
            <div className="flex sticky left-0 z-10 bg-muted/40">
          ...
          <div className="flex bg-muted/60">
            <div className="flex sticky left-0 z-10 bg-muted/60">
              <div className="w-16 px-2 py-2.5 text-xs font-semibold border-r border-border"></div>
              <div className="w-20 px-2 py-2.5 text-xs font-semibold border-r border-border"></div>
